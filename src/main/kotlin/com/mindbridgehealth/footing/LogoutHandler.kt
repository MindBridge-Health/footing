...
/**
 * Needed to perform SSO logout with Auth0. By default, Spring will clear the [org.springframework.security.core.context.SecurityContext]
 * and the session. This controller will also log users out of Auth0 by calling the
 * [Auth0 logout endpoint](https://auth0.com/docs/api/authentication?javascript&_ga=2.220855071.683371550.1592511441-1771410918.1592511441#logout).
 */
@Controller
class LogoutHandler
/**
 ...
 */ @Autowired constructor(private val clientRegistrationRepository: ClientRegistrationRepository) :
    ...
    private val clientRegistration: ClientRegistration
         ...
         */
        private get() = clientRegistrationRepository.findByRegistrationId("auth0")
}
