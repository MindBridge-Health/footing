...
class ScheduledInterviewInitiationTask(
    ...
    private fun processScheduledInterview(scheduledInterviewEntity: ScheduledInterviewEntity) {
        ...
        val questionString =
            "Here is your question for your upcoming Mind Bridge Health interview: $interviewQuestionText"
        val encodedQuestion =
            URLEncoder.encode(interviewQuestionText, StandardCharsets.UTF_8.toString())
        val url =
            "http://54.196.211.99/e-c/message.html?cid=6w7x8y9z&mid=1a2b3c4b&rid=12345&rtel=$number&question=$encodedQuestion"
