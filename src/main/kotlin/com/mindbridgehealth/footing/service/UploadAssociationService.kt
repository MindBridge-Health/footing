...
@Component
class UploadAssociationService (private val mediaService: MediaService, private val storytellerService: StorytellerService) {
        ...
        try {
            ...
            if (records != null && records.isArray) {
                for (record in records) {
                    ...
                    val location = URI.create("s3://mindbridgeuploadbucketdev/$objectKey")
