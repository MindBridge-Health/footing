...
class InterviewController(val service: InterviewService) {
    ...
    @PostMapping("/storytellers/{sid}/chroniclers/{cid}")
    fun post(@RequestBody interview: Interview, @PathVariable sid: UUID, @PathVariable cid: UUID): UUID { //TODO: Needs to take Storyteller and Chronicler ids. meaning they must be created ahead of time.
