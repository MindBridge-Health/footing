...
class InterviewServiceTests {
    ...
    fun findByStorytellerId_validId_AllStories() {
        ...
        val expectedInterviewQuestion1 = InterviewQuestion(uuid1.toString(), "question 1", emptyList(), null, expectedQuestion1.id, expectedStory1, completed = true, skipped = false)
        ...
        val expectedInterviewQuestion2 = InterviewQuestion(uuid2.toString(), "question 2", emptyList(), null, expectedQuestion2.id, expectedStory2, completed = true, skipped = false)
